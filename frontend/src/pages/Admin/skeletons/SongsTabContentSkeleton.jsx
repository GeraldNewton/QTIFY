    ...
    <ScrollArea className="h-80 my-1">
      {skeleton?.map((_, ind) => {
        return (
          <div
            key={ind}
            className="grid gap-2 grid-cols-[2fr_2fr_1fr_0.5fr] py-4 border-b-2 border-zinc-500 hover:cursor-pointer"
          >
...
export default SongsTabContentSkeleton;
